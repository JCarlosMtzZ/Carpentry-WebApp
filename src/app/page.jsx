...
export default function Home() {
  ...
  //background: rgb(0,48,85);
  //background: linear-gradient(0deg, rgba(0,48,85,1) 0%, rgba(0,91,162,1) 50%, rgba(0,48,85,1) 100%);

  return (
    <div className="bg-[#003055]/5 flex flex-col md:flex-row items-center justify-center md:h-full">
      <div className="p-6 md:p-16 w-full md:w-[55%] h-[calc(100vh-65px)] md:h-full flex flex-col justify-evenly md:justify-center">
        ...
        <div className=" h-[25%] flex flex-col gap-4 md:justify-end justify-center">
      ...
      <div className="relative md:px-16 w-full md:w-[45%] h-[calc(100vh-65px)] md:h-full flex items-center justify-center">
        ...
        <ImageCarousel images={carouselImages} height='500px' autoPlay={true} indicators={true} local={true} />
      </div>
    </div>
  );
}
